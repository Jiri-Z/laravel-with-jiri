...
<head>
    ...
    <title>{{ config('app.name', __('navigation.logo_text')) }} — {{ __('legal.terms_title') }}</title>
...
<body class="font-sans antialiased text-gray-600 dark:text-gray-300 bg-white dark:bg-gray-950">
    <div class="min-h-screen">
        ...
        <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
            <h1 class="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white tracking-tight">{{ __('legal.terms_title') }}</h1>
            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">{{ __('legal.terms_updated') }}</p>

            <div class="mt-10 space-y-8 text-base leading-relaxed">
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">{{ __('legal.terms_section_1_title') }}</h2>
                    <p class="text-gray-600 dark:text-gray-300">{{ __('legal.terms_section_1_body') }}</p>
                </section>

                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">{{ __('legal.terms_section_2_title') }}</h2>
                    <p class="text-gray-600 dark:text-gray-300">{{ __('legal.terms_section_2_body') }}</p>
                </section>

                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">{{ __('legal.terms_section_3_title') }}</h2>
                    <p class="text-gray-600 dark:text-gray-300">{{ __('legal.terms_section_3_body') }}</p>
                </section>

                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">{{ __('legal.terms_section_4_title') }}</h2>
                    <p class="text-gray-600 dark:text-gray-300">{{ __('legal.terms_section_4_intro') }}</p>
                    <ul class="mt-2 space-y-2 text-gray-600 dark:text-gray-300 list-disc list-inside">
                        <li>{{ __('legal.terms_section_4_item_1') }}</li>
                        <li>{{ __('legal.terms_section_4_item_2') }}</li>
                        <li>{{ __('legal.terms_section_4_item_3') }}</li>
                        <li>{{ __('legal.terms_section_4_item_4') }}</li>
                        <li>{{ __('legal.terms_section_4_item_5') }}</li>
                    </ul>
                </section>

                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">{{ __('legal.terms_section_5_title') }}</h2>
                    <p class="text-gray-600 dark:text-gray-300">{{ __('legal.terms_section_5_body') }}</p>
                </section>

                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">{{ __('legal.terms_section_6_title') }}</h2>
                    <p class="text-gray-600 dark:text-gray-300">{{ __('legal.terms_section_6_body') }}</p>
                </section>

                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">{{ __('legal.terms_section_7_title') }}</h2>
                    <p class="text-gray-600 dark:text-gray-300">{{ __('legal.terms_section_7_body') }}</p>
                </section>

                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">{{ __('legal.terms_section_8_title') }}</h2>
                    <p class="text-gray-600 dark:text-gray-300">{{ __('legal.terms_section_8_body') }}</p>
                </section>

                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">{{ __('legal.terms_section_9_title') }}</h2>
                    <p class="text-gray-600 dark:text-gray-300">{{ __('legal.terms_section_9_body') }}</p>
                </section>
            </div>
        </main>
