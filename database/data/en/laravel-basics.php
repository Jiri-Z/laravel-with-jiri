...
return [
    ...
    'slug' => 'laravel-basics',
    'description' => 'Learn the fundamentals of Laravel from the ground up. Covers routing, controllers, Blade, Eloquent, authentication, and more.',
    'user_email' => 'instructor@example.com',
    'lessons' => [
        0 => [
            'title' => 'What is Laravel?',
            'slug' => 'what-is-laravel',
            'description' => 'An introduction to the Laravel PHP framework, its philosophy, ecosystem, and architecture.',
            'steps' => [
                0 => [
                    'type' => 'reading',
                    'title' => 'What is Laravel?',
                    'content' => 'Laravel is a free, open-source PHP web framework created by Taylor Otwell in 2011. It follows the Model-View-Controller (MVC) architectural pattern and aims to make common web development tasks such as routing, authentication, caching, and queue management more enjoyable and less painful. Laravel emphasizes elegant, expressive syntax and provides a robust set of tools out of the box. Its philosophy centers on developer happiness without sacrificing application quality. Laravel is built on top of Symfony components and leverages modern PHP features like traits, interfaces, and dependency injection. The framework has grown into a complete ecosystem with tools for every stage of development, from local environment setup to production deployment. Laravel is currently one of the most popular PHP frameworks, powering everything from small blogs to enterprise-level applications. Its extensive documentation, large community, and long-term support releases make it a reliable choice for projects of any scale.',
                ],
                1 => [
                    'type' => 'quiz',
                    'title' => 'What is Laravel? Quiz',
                    'quiz_content' => [
                        0 => [
                            'type' => 'single',
                            ...
                            'answer' => 0,
                            'explanation' => 'Taylor Otwell created Laravel and first released it in June 2011.',
                            'difficulty' => 'easy',
                            'topic' => 'laravel',
                        ],
                    ],
                ...
                3 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            'type' => 'single',
                            'question' => 'Which part of MVC is responsible for handling HTTP requests and returning responses?',
                            'options' => [
                                0 => 'Model',
                                1 => 'View',
                                2 => 'Controller',
                            ...
                            'answer' => 2,
                            'explanation' => 'Controllers handle incoming HTTP requests, process user input, interact with models, and return responses.',
                            'difficulty' => 'easy',
                            'topic' => 'laravel',
                        ],
                    ],
                ...
                5 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'Laravel Forge (server management), Nova (admin panels), and Horizon (queue monitoring) are all first-party Laravel tools. Laravel React is not an official Laravel package.',
                            'difficulty' => 'medium',
                            'topic' => 'laravel',
                        ],
                    ],
                ...
                7 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'BCMath and PDO are required by Laravel. GD and Exif are optional extensions not listed in Laravel\'s core requirements.',
                            'difficulty' => 'medium',
                            'topic' => 'laravel',
                        ],
                    ],
                ...
                9 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'The public/index.php file is the entry point that bootstraps the framework and handles all incoming HTTP requests.',
                            'difficulty' => 'easy',
                            'topic' => 'laravel',
                        ],
                    ],
            ...
            'steps' => [
                ...
                1 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'Web routes are defined in routes/web.php, which is loaded by the RouteServiceProvider with the web middleware group.',
                            'difficulty' => 'easy',
                            'topic' => 'routing',
                        ],
                    ],
                ...
                3 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            'type' => 'single',
                            'question' => 'How do you define an optional route parameter in Laravel?',
                            'options' => [
                                0 => 'Route::get(\'/user/{name?}\', ...)',
                                1 => 'Route::get(\'/user/{name}*\', ...)',
                                2 => 'Route::get(\'/user/{name:optional}\', ...)',
                                3 => 'Route::get(\'/user/[name]\', ...)',
                            ],
                            'answer' => 0,
                            'explanation' => 'Optional parameters use a question mark suffix and the corresponding variable must have a default value.',
                            'difficulty' => 'easy',
                            'topic' => 'routing',
                        ],
                    ],
                ...
                5 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'Named routes enable URL generation with route() helper. Prefix and middleware groups are valid. Route::constraint() is not a valid method.',
                            'difficulty' => 'medium',
                            'topic' => 'routing',
                        ],
                    ],
                ...
                7 => [
                    'type' => 'quiz',
                    'title' => 'Route Model Binding Quiz',
                    'quiz_content' => [
                        0 => [
                            'type' => 'single',
                            'question' => 'What happens automatically when a route with implicit model binding cannot find the model?',
                            'options' => [
                                0 => 'A 404 response is returned',
                                1 => 'A 500 error is thrown',
                                2 => 'Null is passed to the controller',
                                3 => 'An exception is logged and execution continues',
                            ],
                            'answer' => 0,
                            'explanation' => 'Laravel automatically generates a 404 response when implicitly bound models are not found in the database.',
                            'difficulty' => 'medium',
                            'topic' => 'routing',
                        ],
                    ],
                ...
                9 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'Fallback routes must be last, throttle works on any routes, named limiters are defined with RateLimiter::for(), and rate limiting works on web routes too.',
                            'difficulty' => 'medium',
                            'topic' => 'routing',
                        ],
                    ],
            ...
            'steps' => [
                ...
                3 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'Invokable controllers implement the __invoke magic method and are registered as single-action controllers.',
                            'difficulty' => 'easy',
                            'topic' => 'controllers',
                        ],
                    ],
                ...
                5 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'Resource controllers generate index, create, store, show, edit, update, and destroy. \\"delete\\" is not a standard resource controller method.',
                            'difficulty' => 'medium',
                            'topic' => 'controllers',
                        ],
                    ],
                ...
                7 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            'type' => 'single',
                            'question' => 'How does Laravel distinguish between route parameters and injected dependencies in a controller method?',
                            'options' => [
                                0 => 'By type hints',
                                1 => 'By parameter name',
                                2 => 'By the order of parameters',
                                3 => 'By a special attribute',
                            ],
                            'answer' => 0,
                            'explanation' => 'Laravel uses PHP type hints to identify dependencies that need injection. Route parameters without type hints are treated as URI segments.',
                            'difficulty' => 'medium',
                            'topic' => 'controllers',
                        ],
                    ],
                ...
                9 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'The authorize method in a FormRequest class determines if the user is authorized to make the request.',
                            'difficulty' => 'medium',
                            'topic' => 'controllers',
                        ],
                    ],
                ...
                1 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'Blade view files use the .blade.php extension and are stored in the resources/views directory.',
                            'difficulty' => 'easy',
                            'topic' => 'blade',
                        ],
                    ],
                ...
                3 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'The \\$loop variable is automatically available inside Blade loops and provides properties like iteration, first, last, count, and remaining.',
                            'difficulty' => 'easy',
                            'topic' => 'blade',
                        ],
                    ],
                ...
                5 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => '@extends specifies the parent layout, @section defines content sections, and @yield defines where content is displayed. @include is for including partials, not for inheritance.',
                            'difficulty' => 'medium',
                            'topic' => 'blade',
                        ],
                    ],
                ...
                7 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'Prefixing an attribute with \\":\\" tells Blade to evaluate the value as a PHP expression rather than a literal string.',
                            'difficulty' => 'medium',
                            'topic' => 'blade',
                        ],
                    ],
                ...
                5 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'migrate:fresh drops all tables and re-runs all migrations. migrate:rollback undoes the last batch. migrate:reset rolls back all migrations. migrate:revert is not a valid command.',
                            'difficulty' => 'medium',
                            'topic' => 'migrations',
                        ],
                    ],
        ...
        5 => [
            ...
            'steps' => [
                ...
                1 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'Eloquent implements the ActiveRecord pattern where each model class corresponds to a database table and each instance represents a row.',
                            'difficulty' => 'easy',
                            'topic' => 'eloquent',
                        ],
                    ],
                ...
                3 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'Eloquent expects snake_case for columns and table names. camelCase is used for relationship methods, not column names.',
                            'difficulty' => 'medium',
                            'topic' => 'eloquent',
                        ],
                    ],
                ...
                8 => [
                    'type' => 'reading',
                    'title' => 'Eloquent Collections, Accessors, and Serialization',
                    'content' => 'When Eloquent retrieves multiple records, it returns an Eloquent Collection object, which extends Laravel\'s base Collection class with additional model-specific methods. Collections provide powerful data manipulation methods: "filter", "map", "reject", "sortBy", "groupBy", "pluck", "contains", and "each". Eloquent-specific methods include "modelKeys" (returns primary keys), "load" (lazy-loads relationships), "loadCount", "makeVisible", "makeHidden", and "fresh". Accessors allow you to compute custom attribute values on the fly. Define an accessor by adding a method following the pattern "get{AttributeName}Attribute": "public function getFullNameAttribute(): string { return $this->first_name.\' \'.$this->last_name; }". The attribute is then accessible as "$user->full_name". Accessors can also be added to the model\'s $appends array to include them in JSON serialization. Mutators (setters) follow the pattern "set{AttributeName}Attribute" and manipulate data before saving. Serialization controls how models are converted to arrays or JSON. The "$hidden" property hides sensitive attributes like passwords: "protected $hidden = [\'password\', \'remember_token\']". The "$casts" property casts attributes to native types: "protected $casts = [\'is_admin\' => \'boolean\', \'metadata\' => \'array\']". Laravel also supports custom casters for complex types.',
                ],
                9 => [
                    'type' => 'quiz',
                    'title' => 'Collections and Accessors Quiz',
                    'quiz_content' => [
                        0 => [
                            'type' => 'single',
                            'question' => 'What is the method naming convention for an Eloquent accessor?',
                            'options' => [
                                0 => 'get{AttributeName}Attribute',
                                1 => 'access{AttributeName}',
                                2 => 'getAttribute{Name}',
                                3 => 'retrieve{AttributeName}',
                            ],
                            'answer' => 0,
                            'explanation' => 'Accessors follow the \\"get{AttributeName}Attribute\\" pattern, like \\"getNameAttribute\\" for the \\"name\\" attribute.',
                            'difficulty' => 'medium',
                            'topic' => 'eloquent',
                        ],
                    ],
                ...
                1 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'The belongsTo method defines the inverse of both hasOne and hasMany relationships on the child model.',
                            'difficulty' => 'easy',
                            'topic' => 'eloquent',
                        ],
                    ],
                ...
                3 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'attach, sync, and toggle are valid methods for managing many-to-many relationships. push is not a relationship management method.',
                            'difficulty' => 'medium',
                            'topic' => 'eloquent',
                        ],
                    ],
        ...
        7 => [
            ...
            'description' => 'Build full CRUD functionality with Laravel: index, create, store, show, edit, update, and destroy.',
            'steps' => [
                0 => [
                    'type' => 'reading',
                    'title' => 'The CRUD Pattern in Laravel',
                ...
                1 => [
                    'type' => 'quiz',
                    'title' => 'CRUD Pattern Quiz',
                    'quiz_content' => [
                        0 => [
                            'type' => 'single',
                            'question' => 'Which HTTP method is used for the "update" action in a Laravel resource controller?',
                            'options' => [
                                0 => 'PUT',
                                1 => 'POST',
                                2 => 'DELETE',
                            ...
                            'answer' => 0,
                            'explanation' => 'The update action uses PUT (or PATCH) HTTP method to update an existing resource.',
                            'difficulty' => 'easy',
                            'topic' => 'crud',
                        ],
                    ],
                ...
                5 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'Form requests validate input, redirecting is standard post-submit behavior, and flash messages provide user feedback. Returning the form view (re-rendering) is not the standard pattern.',
                            'difficulty' => 'medium',
                            'topic' => 'crud',
                        ],
                    ],
                ...
                7 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'The update action uses PUT (or PATCH) HTTP method, with @method(\'PUT\') in the Blade form for HTML form spoofing.',
                            'difficulty' => 'easy',
                            'topic' => 'crud',
                        ],
                    ],
                ...
                9 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'DELETE forms use method spoofing, soft deletes set deleted_at, and they can be restored. Authorization is never optional for destructive actions.',
                            'difficulty' => 'medium',
                            'topic' => 'crud',
                        ],
                    ],
                ...
                1 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'The @csrf directive generates a hidden input field containing a CSRF token to protect against cross-site request forgery.',
                            'difficulty' => 'easy',
                            'topic' => 'forms',
                        ],
                    ],
                ...
                3 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'The "confirmed" rule expects a matching field_confirmation field. The "same" rule explicitly specifies the field name to match against.',
                            'difficulty' => 'medium',
                            'topic' => 'validation',
                        ],
                    ],
                ...
                5 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'The $errors variable, an instance of MessageBag, is automatically shared with all Blade views by Laravel\'s error middleware.',
                            'difficulty' => 'easy',
                            'topic' => 'validation',
                        ],
                    ],
                ...
                7 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'The rules() method returns an array of validation rules that will be applied to the incoming request.',
                            'difficulty' => 'easy',
                            'topic' => 'validation',
                        ],
                    ],
        ...
        9 => [
            ...
            'steps' => [
                ...
                1 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'config/auth.php defines authentication guards, user providers, and password reset configuration.',
                            'difficulty' => 'easy',
                ...
                2 => [
                    'type' => 'reading',
                    'title' => 'Authentication Guards and Protecting Routes',
                ...
                3 => [
                    'type' => 'quiz',
                    'title' => 'Guards and Route Protection Quiz',
                    'quiz_content' => [
                        0 => [
                            'type' => 'multiple',
                            'question' => 'Which of the following are valid uses of Laravel authentication guards? (Select all that apply)',
                            'options' => [
                                0 => 'Protecting routes with middleware(\'auth\')',
                                1 => 'Using multiple guards for admin and user areas',
                                2 => 'Authenticating with Auth::attempt()',
                                3 => 'Encrypting passwords with bcrypt() automatically',
                            ],
                            'answer' => [
                                0 => 0,
                                1 => 1,
                            ...
                            'explanation' => 'Route protection, multiple guards, and manual authentication are all guard features. bcrypt() is automatic for passwords but is not a guard feature itself.',
                            'difficulty' => 'medium',
                            'topic' => 'authentication',
                        ],
                    ],
                ...
                5 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'Auth::check() returns true when a user is authenticated and false otherwise. Auth::guest() is the inverse.',
                            'difficulty' => 'easy',
                            'topic' => 'authentication',
                        ],
                    ],
                ...
                7 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'MustVerifyEmail interface, verified middleware, and markEmailAsVerified() are all correct. Emails are queueable but not synchronous by default behavior.',
                            'difficulty' => 'medium',
                            'topic' => 'authentication',
                        ],
                    ],
                ...
                9 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            'type' => 'single',
                            'question' => 'Which Blade directive conditionally shows content based on authorization?',
                            'options' => [
                                0 => '@can',
                                1 => '@auth',
                                2 => '@if',
                            ...
                            'answer' => 0,
                            'explanation' => '@can checks if the current user is authorized for a given action and model before rendering content.',
                            'difficulty' => 'medium',
                            'topic' => 'authentication',
                        ],
                    ],
                ...
                1 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'Has-one-through involves the parent table, an intermediate table, and the related (target) table — three tables total.',
                            'difficulty' => 'hard',
                            'topic' => 'eloquent',
                        ],
                    ],
                ...
                3 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'withPivot defines extra columns, wherePivot filters by pivot columns, and updateExistingPivot modifies pivot records. pivotData is not a valid method.',
                            'difficulty' => 'medium',
                            'topic' => 'eloquent',
                        ],
                    ],
                ...
                5 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'morphedByMany defines the inverse on the parent model (e.g., Post.tags), while morphToMany defines it on the shared model (e.g., Tag.posts).',
                            'difficulty' => 'hard',
                            'topic' => 'eloquent',
                        ],
                    ],
                ...
                7 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'doesntHave() filters models that have zero related records. It\'s the inverse of has().',
                            'difficulty' => 'medium',
                            'topic' => 'eloquent',
                        ],
                    ],
                ...
                9 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'Trust proxies correctly identifies client IP, generates HTTPS URLs when behind a proxy, and accepts "*" for all proxies. It is useful in any environment behind a proxy.',
                            'difficulty' => 'hard',
                            'topic' => 'middleware',
                        ],
                    ],
                ...
                3 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'The -m, -c, and -f flags create a migration, controller, and factory alongside the model. The -t flag is not a valid make:model option.',
                            'difficulty' => 'easy',
                            'topic' => 'artisan',
                        ],
                    ],
                ...
                7 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'The $signature property defines the command name, arguments, and options in a string format like "command:name {argument} {--option}".',
                            'difficulty' => 'medium',
                            'topic' => 'artisan',
                        ],
                    ],
                ...
                9 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'daily(), everyFiveMinutes(), and weekly() are valid scheduler methods. The correct method for hourly is hourly(), not everyHour().',
                            'difficulty' => 'medium',
                            'topic' => 'artisan',
                        ],
                    ],
            ...
            'steps' => [
                ...
                1 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            'type' => 'single',
                            'question' => 'Which command runs all tests in a Laravel application?',
                            'options' => [
                                0 => 'php artisan test',
                                1 => 'php artisan test:run',
                                2 => 'php artisan tests',
                                3 => 'php artisan phpunit',
                            ],
                            'answer' => 0,
                            'explanation' => '\'php artisan test\' runs all tests defined in the tests/ directory.',
                            'difficulty' => 'easy',
                            'topic' => 'testing',
                        ],
                    ],
                ...
                3 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'Laravel supports feature tests, unit tests, and Livewire component tests. "Integration tests" is not a distinct Laravel test category (feature tests serve that role).',
                            'difficulty' => 'medium',
                            'topic' => 'testing',
                        ],
                    ],
                ...
                5 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'assertOk() is the most readable assertion for checking a 200 status code. assertStatus(200) also works but is more verbose.',
                            'difficulty' => 'easy',
                            'topic' => 'testing',
                        ],
                    ],
                ...
                7 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'explanation' => 'assertDatabaseHas, assertDatabaseMissing, and assertSoftDeleted are valid assertions. assertRecordExists is not a Laravel assertion.',
                            'difficulty' => 'medium',
                            'topic' => 'testing',
                        ],
                    ],
                ...
                9 => [
                    ...
                    'quiz_content' => [
                        0 => [
                            ...
                            'answer' => 0,
                            'explanation' => 'Livewire::test(Component::class) creates a testable Livewire component instance with methods like set(), call(), and assertSee().',
                            'difficulty' => 'medium',
                            'topic' => 'testing',
                        ],
                    ],
